...
Label & Conductor & $a_p(E)$ & rank & $V_0$ & $(G_{V_0}, H_{V_0})$ \\
\hline
\texttt{17963c1}  & 17\,963  & $-2$ & 2 & 3 & $(-2,\,\, -7/4)$ \\
\texttt{70449a1}  & 70\,449  & $-2$ & — & 4 & $(-2,\,\, -7/4)$ \\
\texttt{53461b1}  & 53\,461  & $-2$ & 3 & 5 & $(-1/4,\, -1)$ \\
\texttt{55935g1}  & 55\,935  & $-2$ & — & 5 & $(-2,\,\, -7/4)$ \\
\hline
\end{tabular}
\caption{$(G_{V_0}, H_{V_0})$ for four $a_p = -2$ supersingular curves at the
first non-vanishing Mazur--Tate stage, recovered from SageMath's
\texttt{Dp\_valued\_series} via the bridge formula~\eqref{eq:bridge-explicit}.
All values lie in $\Q^2$. The values for the remaining 176 verified curves
are tabulated in the supplementary code repository (see Section~\ref{sec:numerical}).}
\label{tab:sample}
\end{table}
